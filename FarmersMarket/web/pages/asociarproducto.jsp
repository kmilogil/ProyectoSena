                                    ...
                                    <table class="table table-hover" id="rtProductos">
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                listaProductos = (ArrayList<ProductoDto>) faOfer.obtenerTodosLosProductos(actualUsuario.getIdUsuario());
                                                for (ProductoDto p : listaProductos) {
                                            %>
                                            <tr>
                                                <td><%= p.getNombres()%></td>
                                                <td><%= p.getCatDto().getDescripcion()%></td>
                            ...
                            <div class="modal fade bs-example-modal-sm" id="modalConfirmarAsociarProducto" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <p class="text-center" id="myModalLabel">!Recuerde que no podra desasociarlos posteriormente¡</p>
                                            <legend></legend>
                                            <center>
